...
namespace Kryz.Utils
{
	public static class BinarySearch
	{
		...
		public static int Search<T>(T[] data, T value) => Search(data.AsSpan(), value, Comparer<T>.Default);
		public static int Search<T>(T[] data, int index, int length, T value) => Search(data.AsSpan(index, length), value, Comparer<T>.Default);
		public static int Search<T, TComparer>(T[] data, T value, TComparer comparer) where TComparer : IComparer<T> => Search(data.AsSpan(), value, comparer);
		public static int Search<T, TComparer>(T[] data, int index, int length, T value, TComparer comparer) where TComparer : IComparer<T> => Search(data.AsSpan(index, length), value, comparer);

		public static int Search<T>(Span<T> data, T value) => Search(data, value, Comparer<T>.Default);

		public static int Search<T, TComparer>(Span<T> data, T value, TComparer comparer) where TComparer : IComparer<T>
		{
			int min = 0;
